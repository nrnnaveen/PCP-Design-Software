...
export const AboutModal: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-cad-panel border border-cad-border w-[560px] max-w-full rounded-sm shadow-xl flex flex-col overflow-hidden text-cad-text animate-in fade-in zoom-in-95 duration-100">
        {/* Header */}
        ...
        {/* Content */}
        <div className="p-4 space-y-3 text-xs text-cad-text">
          ...
          <div className="pt-1.5 text-[10px] text-cad-textMuted font-mono flex items-center justify-between border-t border-cad-border">
