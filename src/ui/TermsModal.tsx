      ...
      <div className="bg-cad-panel border border-cad-border w-[680px] max-w-full max-h-[85vh] rounded-lg shadow-2xl flex flex-col overflow-hidden text-cad-text animate-in fade-in zoom-in-95 duration-100">
        ...
        <div className="h-12 bg-cad-header border-b border-cad-border px-5 flex items-center justify-between shrink-0">
          <div className="flex items-center space-x-2.5">
            <div className="w-6 h-6 rounded bg-emerald-500/10 border border-emerald-500/25 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
              <Scale size={14} />
            </div>
            <div>
        ...
        <div className="p-5 overflow-y-auto space-y-3.5 text-xs leading-relaxed text-cad-text">
          ...
          <section className="space-y-1.5 pt-2 border-t border-cad-border">
            <div className="p-3 bg-amber-500/10 border border-amber-500/30 rounded text-amber-800 dark:text-amber-200 flex items-start gap-2.5">
          ...
          <section className="space-y-1.5 pt-2 border-t border-cad-border">
            ...
            <div className="bg-cad-subpanel border border-cad-border rounded p-2.5 font-mono text-[11px] space-y-1">
